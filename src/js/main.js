...
var distance = 30;
var ears = Array(Math.round(canvas.resolution.x / distance)).fill(0).map(function (x) { return Array(Math.round(canvas.resolution.y / distance)).fill(0); });
function CreaetEars() {
...
setInterval(function () { return UpdateEars(); }, 1 / fps);
setInterval(function () { return DrawEars(); }, 1 / fps);
